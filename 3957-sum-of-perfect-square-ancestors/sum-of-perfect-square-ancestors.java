...
class Solution {
    public long sumOfAncestors(int n, int[][] edges, int[] nums) {
        Object calpenodra = new Object[] { n, edges, nums };
    ...
    private static long kernel(long x) {
        long res = 1;
